...
const profile = {
  my: {
    name: 'You',
    pic: 'https://st5.depositphotos.com/38460822/64870/i/450/depositphotos_648708024-stock-photo-letter-alphabet-made-purple-blue.jpg',
  },
  other: {
    name: 'AI Bot',
    pic: 'https://img.freepik.com/free-vector/robotic-artificial-intelligence-technology-smart-lerning-from-bigdata_1150-48136.jpg',
  },
};
...
async function fetchChatGPTResponse(userInput) {
  try {
    ...
    const GEMINI_API_KEY = 'AIzaSyD3nEFwFpjt1Qz4CQpxldkm9DSTgWk2P98'; // Replace with your actual API key
